...
std::vector<std::string> Settings::Spammer::KillSpammer::messages = {
		"$nick just got owned by some random pAsted cheat",
		"$nick watches anime",
};
bool Settings::Spammer::RadioSpammer::enabled = false;
std::vector<std::string> Settings::Spammer::NormalSpammer::messages = {
		"This pAste owns me and all",
		"Your Windows p2c sucks my pAste dry",
		"It's free as in FREEDOM!",
		"pAste only let me out so I could play this game, please be nice!",
		"pAste nutted but you keep sucken",
		">tfw no vac on Linux"
};
