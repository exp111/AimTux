...
int __attribute__((constructor)) AntarioInit()
{
	...
	cvar->ConsoleColorPrintf(ColorRGBA(150, 255, 150), "pAste was successfully injected.\n");
...
void __attribute__((destructor)) AntarioShutdown()
{
	...
	*(CamThinkSvCheatsCheck + 0x1) = 0x64;
	...
	cvar->ConsoleColorPrintf(ColorRGBA(255, 150, 150), "pAste has been unloaded successfully.\n");
}
